...
import org.yueweb3j.tx.ChainIdLong;
...
import static org.yueweb3j.codegen.Console.exitError;
import static org.yueweb3j.utils.Collection.tail;
...
public class TruffleJsonFunctionWrapperGenerator extends FunctionWrapperGenerator {
    ...
    public static class Contract {
        ...
        enum Network {
            olympic(0),
            mainnet(ChainIdLong.MAINNET),
            morden(ChainIdLong.EXPANSE_MAINNET),
            ropsten(ChainIdLong.ROPSTEN),
            rinkeby(ChainIdLong.RINKEBY),
            kovan(ChainIdLong.KOVAN);
