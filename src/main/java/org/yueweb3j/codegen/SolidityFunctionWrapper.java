...
import org.yueweb3j.abi.EventEncoder;
import org.yueweb3j.abi.FunctionEncoder;
import org.yueweb3j.abi.TypeReference;
import org.yueweb3j.abi.datatypes.Address;
import org.yueweb3j.abi.datatypes.Event;
...
import org.yueweb3j.protocol.core.RemoteFunctionCall;
import org.yueweb3j.protocol.core.methods.request.EthFilter;
import org.yueweb3j.protocol.core.methods.response.AbiDefinition;
import org.yueweb3j.protocol.core.methods.response.BaseEventResponse;
...
import org.yueweb3j.tx.TransactionManager;
import org.yueweb3j.tx.gas.ContractGasProvider;
import org.yueweb3j.utils.Collection;
import org.yueweb3j.utils.Strings;
import org.yueweb3j.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    MethodSpec buildEventFlowableFunction(
        ...
        flowableMethodBuilder.addStatement(
                "return web3j.yueLogFlowable(filter).map($L)", converter);
