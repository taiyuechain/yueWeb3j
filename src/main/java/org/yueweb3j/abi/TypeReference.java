 ...
 * Typed {@link org.yueweb3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.yueweb3j.abi.datatypes.Type>
    ...
    public static <T extends org.yueweb3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends org.yueweb3j.abi.datatypes.Type> TypeReference<T> create(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.yueweb3j.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.yueweb3j.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends org.yueweb3j.abi.datatypes.Type> baseClass =
