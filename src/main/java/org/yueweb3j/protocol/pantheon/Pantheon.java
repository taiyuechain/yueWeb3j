...
import org.yueweb3j.protocol.eea.Eea;
...
public interface Pantheon extends Eea {
    ...
    /** @deprecated This is deprecated as the method name is wrong. */
    default Request<?, YueAccounts> clicqueGetSigners(DefaultBlockParameter defaultBlockParameter) {
        return cliqueGetSigners(defaultBlockParameter);
    }

    /** @deprecated This is deprecated as the method name is wrong. */
    default Request<?, YueAccounts> clicqueGetSignersAtHash(String blockHash) {
        return cliqueGetSignersAtHash(blockHash);
    }

    Request<?, BooleanResponse> cliqueDiscard(String address);

    Request<?, YueAccounts> cliqueGetSigners(DefaultBlockParameter defaultBlockParameter);

    Request<?, YueAccounts> cliqueGetSignersAtHash(String blockHash);
    ...
    Request<?, YueGetTransactionCount> privGetTransactionCount(
