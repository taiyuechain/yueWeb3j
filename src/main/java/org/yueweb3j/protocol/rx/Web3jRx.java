...
public interface Web3jRx {
     ...
     *     on the blockchain
     */
    Flowable<String> yueBlockHashFlowable();
     ...
     */
    Flowable<String> yuePendingTransactionHashFlowable();
     ...
     *     blockchain
     */
    Flowable<YueBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<YueBlock> replayPastBlocksFlowable(
     ...
     *     in the {@link YueBlock} responses
     ...
     */
    Flowable<YueBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
