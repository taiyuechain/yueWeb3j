...
import org.yueweb3j.protocol.eea.crypto.PrivateTransactionEncoder;
import org.yueweb3j.protocol.eea.crypto.RawPrivateTransaction;
...
import org.yueweb3j.tx.gas.PantheonPrivacyGasProvider;
import org.yueweb3j.tx.response.PollingPrivateTransactionReceiptProcessor;
import org.yueweb3j.tx.response.PrivateTransactionReceiptProcessor;
import org.yueweb3j.utils.Base64String;
import org.yueweb3j.utils.Numeric;

import static org.yueweb3j.utils.Restriction.RESTRICTED;
...
public abstract class PrivateTransactionManager extends TransactionManager {
    ...
    private TransactionReceipt processResponse(final YueSendTransaction transactionResponse)
            throws IOException, TransactionException {
