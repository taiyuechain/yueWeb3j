...
import org.yueweb3j.protocol.core.methods.response.YueGetTransactionReceipt;
...
public abstract class TransactionReceiptProcessor {
    ...
    Optional<? extends TransactionReceipt> sendTransactionReceiptRequest(String transactionHash)
            throws IOException, TransactionException {
        YueGetTransactionReceipt transactionReceipt =
                web3j.yueGetTransactionReceipt(transactionHash).send();
